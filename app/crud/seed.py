...
load_dotenv()  # lee .env
DATABASE_URL = os.getenv("DATABASE_URL") or os.getenv("DATABASE_URI") or os.getenv("DATABASE")

if not DATABASE_URL:
    raise SystemExit("Define DATABASE_URL in .env")
...
def run_seed(sql):
    with engine.begin() as conn:
        # exec_driver_sql permite ejecutar múltiples sentencias SQL juntas
